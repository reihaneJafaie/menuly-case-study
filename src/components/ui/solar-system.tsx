...
export interface SolarSystemItem {
  ...
  svg: string; // React node / Inline SVG rendering the item's logo icon
}
...
const DEFAULT_ORBITS: OrbitConfig[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "Next.js",
        color: "#ffffff",
        svg: "/svgsnapshot/icons8-nextjs.svg",
      },
      {
        id: "flutter",
        label: "Flutter",
        color: "#02569B",
        svg: "/svgsnapshot/icons8-flutter.svg",
      },
      {
        id: "vue",
        label: "Vue.js",
        color: "#42B883",
        svg: "/svgsnapshot/icons8-vue.svg",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        label: "TypeScript",
        color: "#3178C6",
        svg: "/svgsnapshot/icons8-typescript.svg",
      },
      {
        id: "python",
        label: "Python",
        color: "#FFD43B",
        svg: "/svgsnapshot/icons8-python.svg",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        label: "Rust",
        color: "#FF6F30",
        svg: "/svgsnapshot/icons8-rust.svg",
      },
      {
        id: "golang",
        label: "Go",
        color: "#00ADD8",
        svg: "/svgsnapshot/icons8-golang.svg",
      },
    ],
  },
];
          ...
          >
            ...
            {centerLogo ? (
              typeof centerLogo === "string" ? (
                ...
                <div className=" text-[10px] w-14 h-14 md:w-20 md:h-20 rounded-full border-2 border-teal-500/40 shadow-[0_0_30px_rgba(20,184,166,0.3)] z-20 bg-zinc-950 flex items-center justify-center p-2 relative">
                  {centerLogo}
                </div>
              )
            ) : (
